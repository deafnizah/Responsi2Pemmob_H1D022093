<template>
    <ion-modal :is-open="isOpen" @did-dismiss="cancel">
        ...
        <ion-content>
            ...
            <!-- Input untuk Ingredients -->
            <ion-item>
                <ion-textarea v-model="todo.ingredients" label="Ingredients" label-placement="floating"
                    placeholder="Enter Ingredients (separate by commas)" :autogrow="true" :rows="3"></ion-textarea>
            </ion-item>

            <!-- Input untuk Steps -->
            <ion-item>
                <ion-textarea v-model="todo.steps" label="Steps" label-placement="floating"
                    placeholder="Enter Steps (separate by line breaks)" :autogrow="true" :rows="5"></ion-textarea>
            </ion-item>
